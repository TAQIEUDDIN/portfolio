...
void main() {
    ...
    // Inject our beautiful portfolio green colors instead of pure white!
    vec3 topColor = vec3(0.235, 0.553, 0.365); // #3c8d5d
    vec3 bottomColor = vec3(0.133, 0.353, 0.231); // #225a3b
    vec3 color = mix(bottomColor, topColor, st.y);
    float alpha = sdf;
